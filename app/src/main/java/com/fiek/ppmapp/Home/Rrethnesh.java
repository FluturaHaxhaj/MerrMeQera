...
public class Rrethnesh extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.rreth_nesh_drawer);
        navigationView = findViewById(R.id.rreth_navigation_view);
        menuIcon = findViewById(R.id.rreth_menu_icon);
    ...
    private String showUserName() {
        SessionManager sessionManager = new SessionManager(Rrethnesh.this, SessionManager.SESSION_USERSESSION);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_logout:
                ...
                Toast.makeText(Rrethnesh.this, "Jeni shkyqur me sukses", Toast.LENGTH_SHORT).show();
